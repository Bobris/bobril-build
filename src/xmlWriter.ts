...
export class XmlWritter {
    ...
    beginElement(elementName: string) {
    ...
    beginElementPreserveSpaces(elementName: string, preserveSpaces: boolean) {
    ...
    private translateString(text: string, isAttr: boolean) {
        ...
        if (lastIndex == 0) this.buf.addString(text);
