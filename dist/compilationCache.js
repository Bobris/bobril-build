...
class CompilationCache {
    ...
    compile(project) {
        ...
        prom = prom.then(() => {
            project.realRootAbs = program.getCommonSourceDirectory();
            ...
            return prom.then(() => {
                ...
                if (project.totalBundle) {
                    ...
                    let bp = {
                        ...
                        fileExists(name) {
                            if (project.commonJsTemp[name.toLowerCase()] !==
                                undefined)
                                return true;
                            let cached = that.getCachedFileContent(name, project.realRootAbs);
